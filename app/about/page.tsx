  ...
  return (
    <main>
      <Container>
        ...
        <h2 className="text-3xl font-bold mb-4">Early Positioning Thoughts</h2>
        ...
        <h3 className="text-xl font-bold my-4">Elevator Speech (needs work)</h3>
        <p className="my-4">
          Remittances today is a $700 billion industry with high fees, excessive
          paperwork and excessive identity requirements that people often can
          not meet or do not want to meet.
        </p>
        <p className="my-4">
          TradFi payment networks often don&#39;t talk to each other. Or, worse,
          they place obstacles to moving your money from network to another.
        </p>
        <p className="my-4">
        ...
        <p className="my-4">
          Users sending remittances and other cross-border payments assemble the
          available TradFi and crypto building blocks into the transactions they
          need, routing around capital controls, legacy TradFi payment networks
          and other obstacles to deliver funds for family support, business, to
          pay medical expenses, education expenses and to found new small
          enterprises.
        </p>
        <p className="my-4">
          ...
          again -- So everyone can onboard to crypto, spend crypto at merchants,
          save crypto, and exit to fiat when needed.
        </p>
        ...
        <ul className="list-disc pl-5">
          ...
          <li>
            peer-to-peer (users trading directly with each other, lending their
            tradfi accounts, in a non-custodial manner)
          </li>
          <li>
            Web3 (users can own the platform via a DAO, trades are controlled by
            contracts)
          </li>
          <li>
          ...
          <li>global, without protocol-level geo-blocking and multi-lingual</li>
        </ul>
        ...
        <ul className="list-disc pl-5">
          ...
          <li>
            enable TradFi payment networks to talk to each other, reducing fees,
            delays and increasing the velocity of money.
          </li>
          <li>
        ...
        <ul className="list-disc pl-5">
          ...
          <li>
            TradFi payment networks / ledgers that don&#39;t talk to each other
            or are excessively slow
          </li>
