    ...
    <footer className="text-center text-sm mt-10 text-slate bg-slate-100 py-6">
      <nav className="flex flex-wrap justify-center">
        <div className="px-5 py-2">
          <a href="/app" className="text-base leading-6 no-underline">
            App
          </a>
        </div>

        <div className="px-5 py-2">
          <a href="/blog" className="text-base leading-6 no-underline">
            Blog
          </a>
        </div>
        ...
        <div className="px-5 py-2">
          <a href="/roadmap" className="text-base leading-6 no-underline">
            Roadmap
          </a>
        </div>

        <div className="px-5 py-2">
          <a href="/contact" className="text-base leading-6 no-underline">
            Contact
          </a>
        </div>
        <div className="px-5 py-2">
          <a href="/tos" className="text-base leading-6 no-underline">
            Terms
          </a>
        </div>
        <div className="px-5 py-2">
          <a href="/tos#privacy" className="text-base leading-6 no-underline">
            Privacy
          </a>
        </div>
      </nav>
