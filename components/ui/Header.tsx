  ...
  return (
    <header>
      <nav aria-label="Main Navigation">
        <div className="px-4 py-4 flex items-center mx-auto justify-center">
          {/* Logo - always show */}
          ...
          <h1 className="text-xl ml-2 mr-4 font-bold uppercase">Yap Bay</h1>

          {/* Primary Nav Menu */}
          <div className="items-center space-x-1 hidden md:flex">
            <Link href="/app" passHref>
              <span className="py-5 px-3 cursor-pointer whitespace-nowrap">
                App
              </span>
            </Link>
