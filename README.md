...
2. **[yapbay-api](https://github.com/Panmoni/yapbay-api)**
   ...
   - **Role**: REST API for managing accounts, offers, trades and escrow instructions. It also includes a listener for on-chain events.
...
5. **[yapbay-www](https://github.com/Panmoni/yapbay-www)**
...
- X: Follow updates. [@YapBay\_](https://x.com/YapBay_)
